...
import { Plus, Target, Trash2, CheckCircle2, Circle, Calendar } from 'lucide-react';
...
export function Goals() {
  ...
  const [tacticDueWeeks, setTacticDueWeeks] = useState<{ [key: string]: number }>({});
              ...
              >
                <div className="flex items-start justify-between">
                  <div className="flex-1">
                    ...
                    <p className="text-gray-600 ml-8">{goal.description}</p>
                  </div>
                ...
                <div className="w-full bg-gray-200 rounded-full h-2 mt-4 ml-8">
                  <div
                ...
                <div className="border-t border-gray-200 p-6 bg-gray-50">
                  ...
                  <div className="space-y-2">
                    <div className="flex gap-2">
                      ...
                      >
                        <option value="">Due Week (Optional)</option>
